  ...
  head: () => ({
    meta: [
      ...
      { title: "KrishiMitra AI — Smart Farming for Bharat" },
      {
        name: "description",
        content:
          "AI-powered AgriTech platform for Indian farmers: crop advice, disease detection, weather, market prices, and government schemes — in 12 languages.",
      },
      ...
      { property: "og:title", content: "KrishiMitra AI — Smart Farming for Bharat" },
      {
        ...
        content:
          "AI-powered AgriTech platform for Indian farmers. Soil to market, in your language.",
      },
